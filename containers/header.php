          ...
          <div class="relative ml-3">
            <div>
              <button type="button"
                ...
                <img class="h-8 w-8 rounded-full" src="img/endless.svg" alt="">
              </button>
            </div>
          </div>
        </div>
    ...
    <div class="sm:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2">
        <a href="/php_feedback/index.php"
          class="bg-gray-900 text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium <?php echo basename($_SERVER['REQUEST_URI']) == 'index.php' ? 'text-white' : ''; ?>">Home</a>
        <a href="/php_feedback/feedback.php"
          class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium <?php echo basename($_SERVER['REQUEST_URI']) == 'feedback.php' ? 'text-white' : ''; ?>">Feedback</a>
        <a href="/php_feedback/about.php"
          class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium <?php echo basename($_SERVER['REQUEST_URI']) == 'about.php' ? 'text-white' : ''; ?>">About</a>
      </div>
    </div>
  </nav>
</body>
